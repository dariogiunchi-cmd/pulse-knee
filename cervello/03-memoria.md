# PULSE — memoria dell'archivio

> Si legge **prima** di cercare e si riscrive dopo. Serve a non riproporre due volte
> lo stesso lavoro, a riconoscere quando un lavoro nuovo conferma o smentisce uno
> vecchio, e a tenere vive le tensioni irrisolte. Massimo 120 voci.
>
...
2026-09-01 | The Bone & Joint Journal | RCT multicentrico, placca a stabilità angolare vs cerchiaggio a otto nella frattura di rotula scomposta (122 pz) | 10.1302/0301-620X.108B9.BJJ-2026-0517.R1 | frattura rotula, traumatologia, osteosintesi | aperto — 🟢 placca superiore su 3 sottoscale KOOS a 12 mesi (sintomi, sport/tempo libero, qualità di vita), meno rimozioni/fallimenti/reinterventi; cifre esatte di reintervento non riportate nell'abstract
2026-09-01 | The Bone & Joint Journal | Rischio di tromboembolismo venoso dopo protesi di ginocchio/anca/spalla, coorte su dati collegati (Regno Unito, 476.620 procedure) | 10.1302/0301-620X.108B9.BJJ-2025-1018.R2 | protesi totale, trombosi, registro | aperto — 🟢 incidenza TEV 1,6% nel ginocchio, oltre il 30% visibile solo nei dati collegati con la medicina di base; calo nel tempo non spiegato dalle sole linee guida NICE
2026-09-01 | Acta Orthopaedica | Rassegna educativa sulla preservazione meniscale in corso di ricostruzione del LCA (registro norvegese del legamento del ginocchio) | 10.2340/17453674.2026.46526 | menisco, radice meniscale, ramp lesion, lca | aperto — 🟢 riparazione preferita alla resezione per radice laterale posteriore, ramp, manico di secchio, lesioni radiali; riguarda la radice laterale, non la mediale della tecnica transtibiale abituale di Dario
2026-09-01 | The Bone & Joint Journal | Impatto dell'edema osseo laterale concomitante sugli esiti della protesi monocompartimentale mediale (coorte, 124 pz) | 10.1302/0301-620X.108B9.BJJ-2025-1736.R2 | protesi monocompartimentale, edema osseo, selezione del paziente | aperto — 🟢 edema laterale lieve non associato a esiti peggiori a 6,4 anni; progressione radiografica laterale muta (RR 1,03; IC 95% 0,38-2,76 con potenza.py)
2026-09-01 | American Journal of Sports Medicine | Effetto biomeccanico della suture augmentation nella riparazione del collaterale mediale su lassità e forza sul LCA (cadaverico, 7 ginocchia, con Gregory DiFelice) | 10.1177/03635465261476766 | collaterale mediale, multilegamentose, lca, biomeccanica | aperto — 🟢 riparazione ± rinforzo riduce la forza sul LCA vs collaterale sezionato; il rinforzo riduce la lassità in valgo a 15°/30° ma non quella rotatoria anteromediale (muto, campione minimo)
2026-09-01 | Cartilage | Subcondroplastica con calcio-fosfato per edema osseo tibiofemorale in gonartrosi lieve-moderata, coorte prospettica multicentrica (92 ginocchia, con Elizaveta Kon) | 10.1177/19476035261476205 | cartilagine, edema osseo, subcondroplastica | aperto — 🟢 KOOS Pain migliorato a 24 mesi (p<0,0001), sopravvivenza libera da reintervento 91,5%; braccio singolo senza controllo, due coautori dipendenti dall'azienda produttrice (Zimmer Biomet)
2026-09-01 | Osteoarthritis and Cartilage | Modello di diffusione multimodale (KOA-Diff) per prevedere la progressione radiografica dell'artrosi di ginocchio | 10.1016/j.joca.2026.08.013 | intelligenza artificiale, artrosi, imaging predittivo | aperto — ⚪ accuratezza binaria della classe Kellgren-Lawrence 84-92% nel dataset di sviluppo, 90% in validazione esterna (n=80); tocca l'interesse dichiarato per l'IA in medicina, non ancora uno strumento clinico validato prospetticamente
...
2026-08-28 | Orthop Traumatol Surg Res | Revisione sistematica e meta-analisi (16 studi, 647 pz), sutura assorbibile vs non assorbibile nella rifissazione transtibiale pull-out della radice meniscale mediale | 10.1016/j.otsr.2026.104856 | root, transtibiale, sutura | aperto — ⚪ nessuna differenza significativa su IKDC/Lysholm/estrusione/guarigione/conversione a protesi (p 0,06-0,77); conversione a protesi grezza 5% (non assorbibile) vs 22% (assorbibile), non significativa ma numericamente ampia; gli stessi autori avvertono di non leggerlo come equivalenza dimostrata
2026-08-28 | Biomedicines | Coorte retrospettiva taiwanese (40 pz: HTO sola 10, HTO+PRP ricco leucociti 20, HTO+PRP povero leucociti 10), second-look artroscopico | 10.3390/biomedicines14081664 | osteotomia, prp, orthobiologics | aperto — ⚪ VAS/OKS/WOMAC comparabili a 12 mesi in tutti i gruppi; solo LR-PRP con viraggio ICRS significativo vs HTO sola (p<0,05); scarto fra esito clinico e strutturale, gruppi piccoli (10-20 pz), muto sulla parte clinica
2026-08-28 | Arthroplasty Today | Nota di tecnica chirurgica: ricostruzione del MPFL contestuale a protesi totale di ginocchio primaria | 10.1016/j.artd.2026.102107 | mpfl, protesi totale, instabilità rotulea | aperto — ⚪ per instabilità rotulea cronica con malracking intraoperatorio persistente nonostante corretto posizionamento delle componenti; fissazione patellare individualizzata, tunnel femorale isometrico; nessun dato clinico, livello V, riservata a casi molto selezionati
...
addition of a LET to a HT graft is still present when using stronger, stiffer BPTB
or QT grafts»*. La lacuna è ora **citabile**, non più solo argomentabile.

Primo dato empirico su innesto rigido: il lavoro di Córdoba su BPTB, negativo ma
sottopotente in modo irrimediabile — con tassi di fallimento del 4-5% e 75 pazienti
per braccio non può escludere nemmeno un dimezzamento del rischio. **Non è uno
studio negativo, è uno studio muto.** Segnale non significativo di maggiore artrosi
...
bendelletta 1 × 8 cm, *«tunnelled **under the fibular collateral ligament** (FCL)
and attached to the femur with a **Richards' staple** (Smith and Nephew)»*,
fissazione a 60-70° in rotazione neutra, tensione <20 N.

**Profondo al collaterale, con graffa. Dario opera superficiale, con onlay.**

Conseguenza: **T1b non si chiude nemmeno nel 2029.** STABILITY 2 risponderà sulla
questione dell'innesto, non su quella del costrutto. Restano due tecniche
biomeccanicamente diverse — decorso rispetto al collaterale e rigidità della
fissazione — che la letteratura tratta come equivalenti.
...
OJSM il timing non è predittore indipendente di ΔKL (p = 0,31). Lo sono l'estrusione
meniscale (β = 0,013; p = 0,023) e la larghezza dello spazio articolare
preoperatoria (β = −0,194; p = 0,051).

I due lavori convergono invece di contraddirsi: il determinante prognostico non è
il grado condrale intraoperatorio e non è il ritardo, è il **carico degenerativo
basale**, e in particolare la percentuale di **estrusione preoperatoria**.

**Ricaduta operativa:** misurare e refertare l'estrusione sulla RM preoperatoria e
usarla nel colloquio sul rischio di progressione, al posto del grado condrale e del
tempo trascorso.
...
dicono *«arthroscopically minced cartilage (using a **shaver**)»*: uno shaver
generico, non la filiera AutoCart. Il confronto non riguarda il dispositivo di Dario.

**E il numero era stato letto male.** Il tritato artroscopico non è *sceso* al 56,6%:
è *partito* dal 50,1% ed è arrivato al 56,6%, e gli autori scrivono *«no statistical
differences over time for all groups»*. Anche la biopsia di controllo partiva dal
56,1%.

**Il dato vero, che nell'abstract non compare:** la densità cellulare del tritato
artroscopico crolla da **700 a 164 cellule/mm²** — tre quarti perse — contro
condroni 797→560 e condrociti 821→670. La percentuale di vitalità è calcolata sulle
sopravvissute.

**Ciò che resta valido e lo riguarda, indipendentemente dal dispositivo:** i campioni
clinici prelevati da difetti debridati e corpi mobili variano **oltre dieci volte**
in peso umido, DNA totale, sGAG/peso e DNA/peso. Non dipende dallo shaver: dipende
da quale tessuto si raccoglie. Gli autori concludono che l'uso clinico senza
regolazione della qualità non è raccomandato.
...
- Un lavoro passa da **aperto** a **risolto** quando ne è stato letto il testo
  completo o quando la questione che poneva è chiusa.
- Un lavoro diventa **superato** quando esce una smentita o una revisione che lo
  assorbe.
- Le tensioni non si cancellano da sole: restano finché non esce il lavoro che le
  chiude, o finché Dario non decide che la questione per lui è chiusa.
- **Una tensione può essere smontata dai fatti.** T2 e T4 lo sono state. Quando
  succede si riscrive e si dice perché — non si difende l'ipotesi iniziale.
